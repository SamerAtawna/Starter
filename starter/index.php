...
<html lang="en">
    ...
    <body>
        ...
        <center>
            ...
            $sql = "select email from users where email='".$_POST['username']."' and password='".$_POST['password']."'";
            $fname = "select firstname from users where email='".$_POST['username']."' and password='".$_POST['password']."'";
            $lname = "select lastname from users where email='".$_POST['username']."' and password='".$_POST['password']."'";
